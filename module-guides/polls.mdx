...
When a user votes on a poll that counts towards the achievements module. See [Achievements](https://docs.yoshibot.com/module-guides/achievements) for more info.
